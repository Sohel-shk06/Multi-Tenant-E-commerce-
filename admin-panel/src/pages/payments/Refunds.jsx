...
export const Refunds = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Refunded Payments</h1>
        <p className="text-sm text-gray-500 mt-1">View all refunded transactions.</p>
      </div>
          ...
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase">Refund Date</th>
              ...
              {transactions.length > 0 ? (
                transactions.map((tx) => (
                  <tr key={tx._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm font-semibold text-red-600">-₹{tx.amount?.toLocaleString()}</span>
                    </td>
                ...
                <tr>
                  <td colSpan="6" className="px-6 py-8 text-center text-gray-500">
                    <RotateCcw className="w-12 h-12 text-gray-300 mx-auto mb-2" />
                    No refunds found.
                  </td>
                </tr>
              )}
