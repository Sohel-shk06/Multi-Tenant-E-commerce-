...
import { Search, Eye, RotateCcw, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const Refunds = () => {
  ...
  useEffect(() => {
    dispatch(fetchTransactions({ page: currentPage, search: searchTerm, status: 'refunded' }));
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-[18px] font-semibold text-gray-900">Refunded Payments</h1>
          <p className="text-[12px] text-gray-400 mt-0.5">View all refunded transactions.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50">
                ...
                <th className="px-5 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Refund Date</th>
              ...
              {transactions.length > 0 ? (
                transactions.map((tx) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-[13px] text-gray-500">
                      {new Date(tx.updatedAt || tx.createdAt).toLocaleDateString('en-IN')}
                    </td>
                ...
                <tr>
                  <td colSpan="6" className="px-6 py-12 text-center">
                    ...
                    >
                      <RotateCcw className="w-5 h-5" style={{ color: '#818CF8' }} />
                    </div>
                    <p className="text-[13px] font-medium text-gray-500">No refunds found</p>
                    <p className="text-[12px] text-gray-400 mt-1">Refunded transactions will appear here</p>
                  </td>
                </tr>
              )}
            </tbody>
        ...
        {totalPages > 1 && (
          <div className="px-5 py-3.5 border-t border-gray-100 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => dispatch(fetchTransactions({ page: currentPage - 1, search: searchTerm, status: 'refunded' }))}
