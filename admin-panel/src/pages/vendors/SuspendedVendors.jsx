...
export const SuspendedVendors = () => {
  ...
  useEffect(() => {
    // ✅ Sirf suspended vendors fetch karein
    dispatch(fetchVendors({ page: currentPage, search: searchTerm, status: 'suspended' }));
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Suspended Vendors</h1>
          <p className="text-sm text-gray-500 mt-1">Manage suspended vendor accounts.</p>
        </div>
        <button 
          ...
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Suspended Date</th>
                  ...
                  <tr key={vendor._id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center text-white text-xs font-bold mr-3">
        ...
        {totalPages > 1 && (
          <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <button
                onClick={() => dispatch(fetchVendors({ page: currentPage - 1, search: searchTerm, status: 'suspended' }))}
