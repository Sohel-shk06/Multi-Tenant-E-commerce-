  ...
  return (
    <div className="min-h-screen w-full flex bg-[#f8fafc] text-slate-800 antialiased font-sans overflow-hidden relative">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative p-16 flex-col justify-between z-10 bg-gradient-to-br from-[#4f46e5] via-[#3b82f6] to-[#6366f1] overflow-hidden">
        {/* Soft, lighter ambient nebulae graphics */}
        ...
        <div className="my-auto max-w-lg relative z-10">
          <h1 className="text-5xl font-black tracking-tight leading-[1.12] text-white uppercase mb-4">
            Join the Future of<br />Online Commerce
          </h1>
          <p className="text-base text-indigo-50/90 leading-relaxed mb-10">
        ...
        {/* Unified Lighter Logo Container Panels */}
      ...
      <div className="flex flex-1 items-center justify-center p-6 lg:p-12 z-10 bg-white shadow-2xl">
        <div className="w-full max-w-[400px]">
          ...
          {successMessage && <div className="mb-4 rounded-xl bg-emerald-50 border border-emerald-100 p-4 text-xs font-bold text-emerald-600">{successMessage}</div>}
          ...
          <p className="text-center text-sm font-medium text-slate-400 mt-8">
            ...
            <Link to="/login" className="text-indigo-600 hover:text-indigo-700 font-bold underline underline-offset-4 decoration-indigo-200">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
