      ...
      <div className="flex flex-1 items-center justify-center p-6 lg:p-12 z-10">
        <div className="w-full max-w-[430px] bg-[#0c081d]/70 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/40">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-12 py-3 bg-white/[0.03] border border-white/10 rounded-xl text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-purple-500 focus:bg-[#110c29] transition-all"
              />
              <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-white text-xs font-semibold">
            ...
            <div className="flex items-center justify-between pt-1 text-xs">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input type="checkbox" className="h-4 w-4 rounded border-white/10 bg-white/5 text-purple-600 focus:ring-transparent cursor-pointer" />
                <span className="text-slate-500 font-medium">Remember this device</span>
              </label>
              <Link to="/forgot-password" className="font-bold text-purple-400 hover:text-purple-300 underline decoration-purple-500/20">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm font-medium text-slate-500 mt-6">
            ...
            <Link to="/register" className="text-purple-400 hover:text-purple-300 font-bold underline underline-offset-4 decoration-white/5">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
