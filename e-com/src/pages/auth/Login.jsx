...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#f8fafc] text-slate-800 antialiased font-sans overflow-hidden relative flex-col lg:flex-row">
      <canvas
        ref={canvasRef}
      ...
      <div className="hidden lg:flex lg:w-1/2 relative px-8 xl:px-16 py-8 flex-col justify-between z-10 bg-gradient-to-br from-[#6400fb] via-[#654ec4] to-[#c03dec] overflow-hidden">
        ...
        <div className="my-auto max-w-lg relative z-10">
          ...
          <p className="text-base text-slate-200 leading-relaxed mb-10">
            Continue your journey in our marketplace and access powerful tools
      ...
      <div
        className="flex flex-1 lg:w-1/2 items-center justify-center
...
"
      >
        <div className="w-full max-w-md lg:max-w-lg">
          {/* Mobile Navbar */}
          <div className="lg:hidden w-full bg-transparent px-5 py-4 flex items-center justify-center z-20">
    ...
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        <p className="text-sm font-semibold text-red-800">
          {error.toLowerCase().includes('suspend') ? 'Account Suspended' : 
           error.toLowerCase().includes('pending') ? 'Account Pending' : 
           'Login Failed'}
        </p>
        <p className="text-xs text-red-600 mt-1">{error}</p>
            ...
            <form
              className="space-y-4 max-w-md lg:max-w-lg"
            ...
            >
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-indigo-600 text-xs font-semibold"
                >
              ...
              <div className="flex items-center justify-between pt-1 text-xs">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-transparent cursor-pointer"
                  />
                ...
                <Link
                  to="/forgot-password"
                  className="font-bold text-indigo-600 hover:text-indigo-700 underline decoration-indigo-200"
                >
                  Forgot password?
                </Link>
              </div>
